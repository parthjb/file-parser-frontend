...
//   // Handle target table change and reset target column
//   const handleTargetTableChange = (newTable) => {
//     const availableColumns = responseData.expected_schema[newTable] || {};
//     const columnNames = Object.keys(availableColumns);
    
//     setEditingMapping({
//       ...editingMapping,
//       target_table: newTable,
//       target_column: columnNames.length > 0 ? columnNames[0] : '' // Reset to first available column
//     });
//   };

//   // Helper function to get clean column name (without type annotation)
//   const getCleanColumnName = (columnWithType) => {
//     return columnWithType.replace(/\s*\(.*?\)/g, "");
//   };

//   // Helper function to get column with type annotation
//   const getColumnWithType = (columnName, tableName) => {
//     const schema = responseData.expected_schema[tableName];
...
//                         </label>
//                         <select
//                           value={getCleanColumnName(editingMapping.target_column)}
//                           onChange={(e) =>
//                             setEditingMapping({
//                               ...editingMapping,
//                               target_column: getColumnWithType(e.target.value, editingMapping.target_table),
//                             })
//                           }
//                           className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
//                         >
...
//                           {getCleanColumnName(mapping.source_field)}
//                         </div>
//                       </div>
//                       <div>
...
//                           {mapping.target_column || 'No column selected'}
//                         </div>
//                       </div>
//                     </div>
